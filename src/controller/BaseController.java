...
public class BaseController implements Initializable{
     ...
     * fxml files and it will be used to navigate
     ...
     * @param URL: fxml file path; scene
     * @throws IOException
     */
    ...
    private void loadFXMLMap() {
        ...
        FXML_URL.put("Dashboard", "/fxml/login.fxml");
        FXML_URL.put("Items", "/fxml/inventory.fxml");
        FXML_URL.put("Customers", "/fxml/customer.fxml");
        FXML_URL.put("Dashboard", "/fxml/dashboard.fxml");
        FXML_URL.put("Sells", "/fxml/sells.fxml");
        FXML_URL.put("Rentals", "/fxml/rentals.fxml");
        FXML_URL.put("Accounts", "/fxml/accounts.fxml");
        FXML_URL.put("Administrative", "/fxml/administrator.fxml");
        FXML_URL.put("Update Due", "/fxml/dueupdate.fxml");
    }
