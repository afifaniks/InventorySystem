...
public class Transaction implements Initializable {
    ...
    public static boolean rentOrSale = false; //false for rent & true for sale.
                                                // Field value will be initiated from Rentals or Sells Class
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            ...
            cboTrType.setItems(trTypeList); //Setting Transaction Types
    ...
    private void finalizePurchase() {
        ...
        try {
            ...
            purchaseStmt.setString(5, LogIn.loggerUsername);
            ...
            transactionStmt.setString(6, LogIn.loggerUsername);

            transactionStmt.executeUpdate();

            hideWindow(); //Closing Transaction Window
    ...
    private void finalizeRental() {
        ...
        try {
            ...
            purchaseStmt.setString(6, LogIn.loggerUsername);
