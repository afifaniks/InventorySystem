 ...
 **/
public class TransactionGUI implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            ...
            cboTrType.setItems(trTypeList); //Setting TransactionGUI Types
    ...
    private void finalizePurchase() {
        ...
        try {
            ...
            purchaseStmt.setString(5, LogInGUI.loggerUsername);
            ...
            transactionStmt.setString(6, LogInGUI.loggerUsername);

            transactionStmt.executeUpdate();

            hideWindow(); //Closing TransactionGUI Window
    ...
    private void finalizeRental() {
        ...
        try {
            ...
            purchaseStmt.setString(6, LogInGUI.loggerUsername);
