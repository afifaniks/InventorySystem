    ...
    void saveEmployee(ActionEvent event) {
        ...
        if (flag) {
            ...
            try {
                ...
                new Dialog("Operation Successful", "New Employee added! You can now log in with the given credentials.");
            } catch (SQLException e) {
                if(e.getErrorCode() == 1062) {
                    new Dialog("Operation failed", "This username is already taken. Try another!");
                }
            }
