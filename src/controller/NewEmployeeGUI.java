 ...
 **/
public class NewEmployeeGUI implements Initializable {
    ...
    void saveEmployee(ActionEvent event) {
        ...
        if (flag) {
            ...
            try {
                ...
                new PromptDialogGUI("Operation Successful", "New Employee added! You can now log in with the given credentials.");
            } catch (SQLException e) {
                if(e.getErrorCode() == 1062) {
                    new PromptDialogGUI("Operation failed", "This username is already taken. Try another!");
                }
            }
