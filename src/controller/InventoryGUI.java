 ...
 **/
public class InventoryGUI implements Initializable{
    ...
    public static ObservableList<Item> itemList = FXCollections.observableArrayList(); //This field will auto set from InitializerGUI Class
            ...
            if(entryFlag) {
                ...
                if (result.get() == ButtonType.OK) {
                    ...
                    try {
                        ...
                        new PromptDialogGUI("Operation Successful!", "New Item Added!");
            ...
            if(entryFlag) {
                ...
                if (result.get() == ButtonType.OK) {
                    ...
                    try {
                        ...
                        new PromptDialogGUI("Operation Successful!", "Entry updated!");
