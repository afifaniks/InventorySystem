 ...
 **/
public class AccountListGUI implements Initializable {
    ...
    @FXML
    private TableView<main.Account> tbl;
    ...
    @FXML
    private TableColumn<main.Account, Integer> cusID;

    @FXML
    private TableColumn<main.Account, String> issued;

    @FXML
    private TableColumn<main.Account, String> payType;
    ...
    void deleteAcc(ActionEvent event) {
        ...
        try {
            ...
            new PromptDialogGUI("Operation Failed", "Invalid Arguments!");
        }
    }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        ObservableList<main.Account> list = FXCollections.observableArrayList();
        ...
        try {
            ...
            while (rs.next()) {
                list.add(new main.Account(rs.getInt(1), rs.getString(2), rs.getInt(3), rs.getString(4), rs.getString(5)));
            }
    ...
    private void loadContents() {
        main.Account accountFieldEditorData = tbl.getSelectionModel().getSelectedItem();
