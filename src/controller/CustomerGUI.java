...
public class CustomerGUI implements Initializable {
    ...
    @FXML
    private TableView<main.Customer> tbl;

    @FXML
    private TableColumn<main.Customer, Integer> columnID;

    @FXML
    private TableColumn<main.Customer, String> columnFirstName;

    @FXML
    private TableColumn<main.Customer, String> columnLastName;

    @FXML
    private TableColumn<main.Customer, String> columnGender;

    @FXML
    private TableColumn<main.Customer, String> columnAddress;

    @FXML
    private TableColumn<main.Customer, String> columnPhone;

    @FXML
    private TableColumn<main.Customer, String> columnEmail;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        if(LogInGUI.loggerAccessLevel.equals("Admin"))
            ...
            if (btnEditMode.isSelected() && event.getClickCount() == 2) {
                ...
                if(imgFile != null) { //This block will be only executed if there is any file chosen
                    ...
                    if(imgPath.contains(".jpg") || imgPath.contains(".png") || imgPath.contains(".gif") ||imgPath.contains(".jpeg")) {
                        ...
                        new PromptDialogGUI("File Format Error!", "Please select a valid image file. You can select JPG, JPEG, PNG, GIF");
                    }
                }
    ...
    void showPurchases(ActionEvent event) {
        try {
            CustomerPurchaseListGUI.customerID = Integer.valueOf(customerID.getText());
    ...
    void showrentals(ActionEvent event) {
        try {
            CustomersRentalListGUI.customerID = Integer.valueOf(customerID.getText());
    ...
    void btnDelAction(ActionEvent event) {
        ...
        if(result.get() == ButtonType.OK) {
            ...
            try {
                ...
                new PromptDialogGUI("Operation Successful.", "Item is deleted from the database. Restart or refresh to see effective result.");
            } catch (SQLException e) {
                if(e.getErrorCode() == 1451) {
                    new PromptDialogGUI("Constraint Error", "Customer has accounts & may be transactions. You need to delete them first in Admin Panel if you want to delete this entry");
                }
            ...
            if(entryFlag) {
                ...
                if (result.get() == ButtonType.OK) {
                    ...
                    try {
                        ...
                        new PromptDialogGUI("Operation Successful!", "New Customer Added!");
            ...
            if(entryFlag) {
                ...
                if (result.get() == ButtonType.OK) {
                    ...
                    try {
                        ...
                        new PromptDialogGUI("Operation Successful!", "The record is updated!");
                        reloadRecords();
