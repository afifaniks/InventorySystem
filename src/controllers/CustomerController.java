...
public class CustomerController implements Initializable {
    ...
    public static ObservableList<main.Customer> customersList = FXCollections.observableArrayList(); //This field will auto set from InitializerController Class
    ...
    private void recordNavigator() {
        ...
        if (onView.getPhoto() == null) {
            ImagePattern img = new ImagePattern(new Image("/resources/icons/user.png"));
    ...
    void showPurchases(ActionEvent event) {
        try {
            ...
            Parent pur = FXMLLoader.load(getClass().getResource("/resources/view/customerpurchase.fxml"));
    ...
    void showrentals(ActionEvent event) {
        try {
            ...
            Parent rent = FXMLLoader.load(getClass().getResource("/resources/view/customerrentals.fxml"));
    ...
    void btnDelAction(ActionEvent event) {
        ...
        alert.setGraphic(new ImageView(this.getClass().getResource("/resources/icons/x-button.png").toString()));
    ...
    void saveEntry(ActionEvent event) {
        if (addFlag) {
            ...
            if(entryFlag) {
                ...
                alert.setGraphic(new ImageView(this.getClass().getResource("/resources/icons/question (2).png").toString()));
