...
public class AdministratorController implements Initializable {
     ...
     * @param URL: resources.view file location
     */
    ...
    void accUpdate(ActionEvent event) {
        loadWindow("Account Management", "/resources/view/accountmanager.fxml");
    }

    @FXML
    void itemTypeManage(ActionEvent event) {
        loadWindow("Item Type Management", "/resources/view/itemtypemanager.fxml");
    }

    @FXML
    void addNewEmployee(ActionEvent event) {
        loadWindow("Add Employee", "/resources/view/newemployee.fxml");
    }
    ...
    void empList(ActionEvent event) {
        loadWindow("Employee Management", "/resources/view/employeelist.fxml");
    }


    @FXML
    void showTransactions(ActionEvent event) {
        loadWindow("Transaction List", "/resources/view/translist.fxml");
    }

    @FXML
    void totalRents(ActionEvent event) {
        loadWindow("Rental List", "/resources/view/rentallist.fxml");
    }

    @FXML
    void totalSell(ActionEvent event) {
        loadWindow("Sell List", "/resources/view/selllist.fxml");
    }
