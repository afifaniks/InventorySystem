...
public class BaseController implements Initializable{
     ...
     * resources.view files and it will be used to navigate
     ...
     * @param URL: resources.view file path; scene
     * @throws IOException
     */
    ...
    private void loadFXMLMap() {
        ...
        FXML_URL.put("Dashboard", "/resources/view/login.fxml");
        FXML_URL.put("Items", "/resources/view/inventory.fxml");
        FXML_URL.put("Customers", "/resources/view/customer.fxml");
        FXML_URL.put("Dashboard", "/resources/view/dashboard.fxml");
        FXML_URL.put("Sells", "/resources/view/sells.fxml");
        FXML_URL.put("Rentals", "/resources/view/rentals.fxml");
        FXML_URL.put("Accounts", "/resources/view/accounts.fxml");
        FXML_URL.put("Administrative", "/resources/view/administrator.fxml");
        FXML_URL.put("Update Due", "/resources/view/dueupdate.fxml");
    }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            ctrlRightPane("/resources/view/dashboard.fxml");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    private void logOut() {
        ...
        try {
            ...
            root.getStylesheets().add("/resources/css/login.css");
