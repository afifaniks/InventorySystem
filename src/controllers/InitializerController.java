    ...
    public void initialize(URL location, ResourceBundle resources) {
       ...
       // progressIndicator.progressProperty().bind(t.progressProperty());
        ...
        initializerTask.setOnSucceeded(e -> {
            ...
            try {
                root = FXMLLoader.load(getClass().getResource("/resources/view/base.fxml"));
                Scene scene = new Scene(root);
                String css = this.getClass().getResource("/resources/css/base.css").toExternalForm();
                scene.getStylesheets().add(css);
                base.setTitle("Inventory System");
                base.getIcons().add(new Image("/resources/icons/Logo.png"));
                base.setScene(scene);
